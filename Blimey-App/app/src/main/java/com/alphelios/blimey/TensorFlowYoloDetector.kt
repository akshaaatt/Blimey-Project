...
class TensorFlowYoloDetector private constructor() : Classifier {
        ...
        for (y in 0 until gridHeight) {
            for (x in 0 until gridWidth) {
                for (b in 0 until NUM_BOXES_PER_BLOCK) {
                    val offset = gridWidth * (NUM_BOXES_PER_BLOCK * (NUM_CLASSES + 5)) * y + NUM_BOXES_PER_BLOCK * (NUM_CLASSES + 5) * x + (NUM_CLASSES + 5) * b
    ...
    companion object {
        ...
        // from files.
        private val ANCHORS = doubleArrayOf(
                1.08, 1.19,
                3.42, 4.41,
                6.63, 11.38,
                9.42, 5.11,
        ...
        fun create(
            ...
            d.outputNames = outputName.split(",".toRegex()).toTypedArray()
